...
KTMenu.getInstance = function(element) {
    ...
    // Attempt to find the closest menu element
    // Check if the menu element is found and has the 'menu' data
    // if (menu && KTUtil.data(menu).has('menu')) {
    //     return KTUtil.data(menu).get('menu');
    // } else {
    //     // Return blank data (or any default value you prefer)
